...
images = ["rsz_ghost.gif", "rsz_gh.gif", "rsz_gh2.gif", "rsz_pl3.gif", "rsz_coin1.gif", "rsz_wall.gif",
          "rsz_energy.gif","rsz_fruit2.gif"]
for i in images:
...
def start_game():
    ...
    for e in enemies:
        ...
        print(player.xcor(), player.ycor(), e.targetx, e.targety)
...
def btnclk(x, y):
    ...
    if x > 0 and x < 81 and y > 0 and y < 30:
        print("hello")
        turtle.Screen().bye()
    elif x > -10 and x < 91 and y > -50 and y < -10:
        print("hello2")
        game_state = "start"
        started = False
        end = False
